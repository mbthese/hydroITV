...
traits <- c("gmin", "RWC", "FmFv", "invLA", "LT", "LDMC", "CC", "Ptlp", "LMA", "invLSWC")
...
```{r modelIntercepts, fig.cap="Model species effect for Intercept.", fig.height=10, fig.width=10}
lapply(fits, function(fit) 
  ...
  left_join(species) %>% 
  mutate(trait = recode(trait, "Ptlp" = "-pi[TLP]", "FmFv" = "frac(Fm,Fv)", "Gmin" = "g[min]", "invLA" = "frac(1,LA)", "invLSWC" = "frac(1,LSWC)")) %>% 
...
```{r modelDBH, fig.cap="Model species effect for DBH slope.", fig.height=10, fig.width=10}
lapply(fits, function(fit) 
...
```{r modelTWI, fig.cap="Model species effect for TWIs & TWIis slope.", fig.height=10, fig.width=10}
lapply(fits, function(fit) 
